...
return [
      ...
      "general" => [
        ...
        "fields" => [
          ...
          "breadcrumbOnlyMainCategory" => [
            ...
            "type" => "select",
            "props" => [
              "label" => "Mostrar Solo categoria principal",
              "options" => [
                ["label" => "Solo categoria principal", "value" => 1],
                ["label" => "Todas las categorias", "value" => 2,
                ]
              ]
            ],
          ],
    ...
    "attributes" => [
      ...
      "gallery" => [
        ...
        "fields" => [
          ...
          "galleryTitleDisplay" => [
            "name" => "galleryTitleDisplay",
            "value" => "2",
            "type" => "select",
            "props" => [
              "label" => "Mostrar Titulo Galería",
              "options" => [
                ["label" => "Si", "value" => "1"],
                ["label" => "No", "value" => "2"],
              ]
          ...
          "galleryTitleColorByClass" => [
            "name" => "galleryTitleColorByClass",
            "type" => "select",
            "props" => [
              "label" => "Titulo Color Class",
              "options" => $vAttributes["textColors"]
            ]
          ],
          "galleryTitleColorCustom" => [
            "name" => "galleryTitleColorCustom",
            "type" => "inputColor",
            "props" => [
              "label" => "Titulo Color Custom",
            ],
            "help" => [
              "description" => "Selecciona el color Custom en Color Class para activarlo",
            ]
          ],
          "galleryTitleMarginTop" => [
            "name" => "galleryTitleMarginTop",
            "type" => "input",
            "props" => [
          ...
          "galleryTitleMarginBottom" => [
            "name" => "galleryTitleMarginBottom",
            "type" => "input",
            "props" => [
          ...
          "galleryTitleClass" => [
            "name" => "galleryTitleClass",
            "type" => "input",
            "columns" => "col-12",
            "props" => [
              "label" => "Clases Title Gallery",
            ],
          ],
          "galleryWithLineTitle" => [
            "name" => "galleryWithLineTitle",
            "value" => "0",
            "type" => "select",
            "columns" => "col-12",
            "props" => [
          ...
          "galleryWithLineTitleConfig" => [
            "name" => "galleryWithLineTitleConfig",
            "value" => ['background' => 'var(--primary)', 'height' => '2px', 'width' => '10%', 'margin' => '0 auto'],
            "type" => "json",
            "columns" => "col-12",
            "props" => [
              "label" => "Configuración de Línea Titulo Galería",
            ]
          ],
          "galleryTitleStyle" => [
            "name" => "galleryTitleStyle",
            "type" => "input",
            "columns" => "col-12",
            "props" => [
              "label" => "Estilos Title Gallery",
              'type' => 'textarea',
              'rows' => 5,
            ],
          ],
  ...
  "LWContentCustom" => [
      "title" => "LW Contenido Custom",
      "systemName" => "ibuilder::lw-content-custom",
      "nameSpace" => "livewire",
      "useViewParams" => true,
      "content" => [
          [
      ...
      "contentFields" => [
          ...
          "itemListTitle" => [
              ...
              "help" => [
                  "description" => "ItemList principal (Blog o Ad)",
              ]
          ],
          "itemListLabelButton" => [
              "name" => "itemListLabelButton",
      ...
      "attributes" => [
          ...
          "filters" => [
              "title" => "Filtros (Category - Post - Ad)",
              "fields" => [
                  "withListMain" => [
                      "name" => "withListMain",
                      "value" => null,
                  ...
                  "itemListLateralTitleClass" => [
                      "name" => "itemListLateralTitleClass",
                      "value" => "mt-1 mb-3",
                      "type" => "input",
                      "props" => [
                          "label" => "Clases Titulo Filtro lateral",
                      ]
                  ],
                  "itemListType" => [
                      "name" => "itemListType",
                  ...
                  "itemListFilter" => [
                      ...
                      "type" => "input",
                      "props" => [
                          "label" => "Filtro (category,parent_id) (Lista Principal)",
                      ]
                  ],
                  "itemListTitleClass" => [
                      "name" => "itemListTitleClass",
                      "type" => "input",
                      "props" => [
                          "label" => "Clases Titulo (Lista Principal)",
                      ]
                  ],
                  "itemListTitleH" => [
                      "name" => "itemListTitleH",
                      "type" => "input",
                      "props" => [
                          "label" => "Etiqueta Titulo (Lista Principal)",
                      ]
                  ],
                  "itemListTitlePage" => [
                      "name" => "itemListTitlePage",
                      "value" => 0,
                      "type" => "select",
                      "props" => [
                          "label" => "Mostrar Titulo (Lista Principal)",
                          "options" => $vAttributes["validation"]
                      ]
                  ],
                  "itemListPagOrderByOn" => [
                      "name" => "itemListPagOrderByOn",
                      "value" => 0,
                      "type" => "select",
                      "props" => [
                          "label" => "Mostrar OrderBy (Lista Principal)",
                          "options" => $vAttributes["validation"]
                      ]
                  ],
                  "itemListTake" => [
                      ...
                      "type" => "input",
                      "props" => [
                          "label" => "Número de elementos (Lista Principal)",
                          "type" => "number",
                      ]
                  ],
                  "itemListCol" => [
                      ...
                      "type" => "input",
                      "props" => [
                          "label" => "Columna de elementos (Lista Principal)",
                      ]
                  ],
                  "itemListPag" => [
                      "name" => "itemListPag",
                      ...
                      "type" => "select",
                      "props" => [
                          "label" => "Mostrar Paginación (Lista Principal)",
                          "options" => $vAttributes["validation"]
                      ]
                  ],
                  "itemListPagType" => [
                      ...
                      "type" => "select",
                      "props" => [
                          "label" => "Tipo paginación (Lista Principal)",
                          "options" => [
                              ["label" => "Normal", "value" => "normal"],
                              ["label" => "LoadMore", "value" => "loadMore"],
                              ["label" => "InfiniteScroll", "value" => "infiniteScroll"],
                  ...
                  "itemListPagStyle" => [
                      ...
                      "columns" => "col-12",
                      "props" => [
                          "label" => "Estilo del Paginador (Lista Principal)"
                      ]
                  ],
                  "itemListPagStyleGeneral" => [
                      "name" => "itemListPagStyleGeneral",
                      ...
                      "columns" => "col-12",
                      "props" => [
                          "label" => "Estilo libre del Paginador (Lista Principal)",
                          'type' => 'textarea',
                          'rows' => 5,
                      ],
                      "help" => [
