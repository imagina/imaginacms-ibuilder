...
@if($withTitle)
    ...
    #{{$customId}} .custom-item-title .title i {
    {!!$titleIconStyle!!}
    }
    @endif
    @if($withLineTitle==1)
    #{{$customId}} .custom-item-title .title:after {
        content: '';
        display: block;
...
@if($withBody)
#{{$customId}} .custom-item-body .body {
...
@if($withGallery)
    ...
    @if($galleryNav)
    #{{$customId}} .custom-item-gallery .gallery .owl-nav  {
        & i {
    ...
    #{{$customId}} .custom-item-gallery .gallery .arrow i {
        color: {{$galleryNavColor}};
        &:hover {
             color: {{$galleryNavColorHover}};
         }
    ...
    @if($galleryDotsStyle=="dots-linear")
       ...
       #{{$customId}} .custom-item-gallery .gallery .owl-dots .owl-dot span {
                width: {{$galleryDotsSize}}px;
                height: 5px;
                margin: 0 5px;
                border-radius: 0;
            }
    #{{$customId}} .custom-item-gallery .gallery .owl-dots .owl-dot.active span,
    #{{$customId}} .custom-item-gallery .gallery .owl-dots .owl-dot:hover span {
    ...
    #{{$customId}} .custom-item-gallery .gallery .owl-dots .owl-dot.active span:after{
...
#{{$customId}} .custom-item-share .share {
     {!!$shareStyle!!}
}
@endif
...
#{{$customId}} .post-list-pagination {
    {!!$itemListPagStyleGeneral!!}
}
@endif
#{{$customId}} .post-list-pagination .page-link {
...
#{{$customId}} .item-category .category {
